...
<head>
    ...
    <title>Truck Supplier Registration - LoadsoR</title>
    <link rel="stylesheet" href="styles/truck-supplier.css" />
</head>
...
<div class="modal-overlay">
    <div class="modal-container">
        ...
        <div class="modal-header">
            <h2 class="modal-title">Broker / Truck Supplier</h2>
        </div>
            ...
            <div class="form-section">
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label class="form-label">Transporter Name <span class="required">*</span></label>
                        <input type="text" class="form-input" placeholder="Enter transporter name" required />
                    </div>
                </div>
